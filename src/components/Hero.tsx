...
const Hero = ({ scrollToSection }: HeroProps) => {
        ...
        try {
          ...
          if ((window as any).VANTA && vantaRef.current) {
            vantaEffect.current = (window as any).VANTA.TOPOLOGY({
              ...
              backgroundColor: 0x1e1b4b, // Dark blue background
              points: 10.00,
              maxDistance: 20.00,
              spacing: 15.00
            });
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900/40 via-purple-900/40 to-indigo-900/40 z-10"></div>
      ...
      <div className="relative z-30 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          <button
            ...
            className="group border-2 border-white text-white px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300 hover:bg-white hover:text-blue-600 hover:scale-105 hover:-translate-y-0.5 backdrop-blur-sm"
          >
            {t('hero.getInTouch')}
          </button>
        </motion.div>
        ...
        >
          ...
          <motion.button
            ...
            className="text-white hover:text-yellow-300 transition-colors hover:scale-110 bg-white/10 backdrop-blur-sm rounded-full p-3 border border-white/20"
