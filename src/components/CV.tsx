...
- English (Proficient)
  ...
  return (
    <section id="cv" className="py-20 bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-gray-900 dark:to-indigo-900/20">
        ...
        >
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-indigo-600 pl-6 bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-r-lg">
              ...
              <p className="text-indigo-600 dark:text-indigo-400 font-medium">DPG Degree College, affiliated by MDU Rohtak, Haryana</p>
