...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.name': 'Sidharth',
    'hero.tagline1': 'Software Engineer with AI Integration',
    'hero.tagline2': 'Problem Solver',
    'hero.tagline3': 'Tech Enthusiast',
    'hero.tagline4': 'Innovation Creator',
    'hero.description': 'Building innovative web experiences with modern technologies and creative solutions.',
    'hero.viewWork': 'View My Work',
    'hero.getInTouch': 'Get In Touch',
    'hero.scrollExplore': 'Scroll to explore',
    'hero.stats.years': 'Years Learning',
    'hero.stats.projects': 'Projects',
    'hero.stats.dedicated': 'Dedicated',
    
    // About Section
    'about.title': 'About Me',
    'about.subtitle': 'Passionate about creating innovative solutions through technology',
    'about.description1': 'I\'m a passionate software engineer currently pursuing my Bachelor\'s in Computer Applications from DPG Degree College, Haryana. With hands-on experience in web development and a keen interest in emerging technologies.',
    'about.description2': 'My expertise spans across Web Development, IoT, and Artificial Intelligence. I\'ve completed internships at SingleInterface and currently serve as an Internshala Student Partner, helping fellow students navigate their career paths.',
    'about.description3': 'When I\'m not coding, you\'ll find me exploring new technologies, participating in tech communities, or working on personal projects that solve real-world problems.',
    'about.downloadResume': 'Download Resume',
    'about.viewProjects': 'View Projects',
    'about.highlights.education': 'Education',
    'about.highlights.education.desc': 'Bachelor\'s in Computer Applications',
    'about.highlights.experience': 'Experience',
    'about.highlights.experience.desc': 'Web Development & IoT',
    ...
    'about.highlights.expertise.desc': 'Full-Stack Development',
    ...
    'footer.description': 'Building the future, one line of code at a time. Passionate about creating innovative web solutions that make a difference.',
